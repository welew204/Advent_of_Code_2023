...
def day17_part1(file_contents):
    heat_map = [[int(n) for n in line.strip()] for line in file_contents]
...
def start():
    # pass
    result = get_file_contents("inputs/day17.txt", day17_part1, remove_line_breaks)
    print("(Part 1) result: ", result)
    result = get_file_contents("inputs/day17.txt", day17_part2, remove_line_breaks)
